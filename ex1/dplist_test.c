...
START_TEST(test_adding_elements)
{
    ...
    dplist_t *list = NULL;
    ck_assert_msg(dpl_get_element_at_index(list,1) ==  -1,"Failure: expected NULL");
...
START_TEST(test_getting_element_with_reference){
    ...
    populate_with_numbers(list);
    ck_assert_msg(dpl_get_index_of_element(list,3)==3,"Failure: expected to be 3");
